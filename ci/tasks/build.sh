...
readonly BUILT_PLUGIN_OUTPUT="${BUILT_PLUGIN_OUTPUT?:must be set}"
readonly CF_CLI_PLUGIN_INPUT="${CF_CLI_PLUGIN_INPUT?:must be set}"
readonly PLUGIN_NAME="${PLUGIN_NAME?:must be set}"
readonly VERSION_INPUT="${VERSION_INPUT?:must be set}"
